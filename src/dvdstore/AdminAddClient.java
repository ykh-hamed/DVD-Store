 ...
 */
public class AdminAddClient extends javax.swing.JFrame {
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        ...
        AdminBrowseClient browseUserAdmin= new AdminBrowseClient();
        browseUserAdmin.setVisible(true);
        browseUserAdmin.setLocationRelativeTo(null);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminAddClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAddClient().setVisible(true);
            }
        });
    }
